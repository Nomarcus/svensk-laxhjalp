      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:pt-[2vh]">
        ...
        <div className="flex-1 flex flex-col justify-center lg:justify-start lg:pt-2 p-3 md:p-6 lg:p-8">
          <div className="max-w-xl mx-auto lg:mx-0 w-full">
            ...
            <h1 className="text-3xl md:text-4xl font-serif italic text-stone-900 mb-1 leading-tight">
              AI-driven läxhjälp för svenska föräldrar
            </h1>
            <p className="text-base text-stone-600 mb-2 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {[
                { icon: <MessageSquare size={14} />, text: "AI-läxhjälp i alla ämnen" },
                { icon: <Camera size={14} />, text: "Fota läxan med mobilen" },
                { icon: <Calendar size={14} />, text: "Veckoplanering & kalender" },
                { icon: <Users size={14} />, text: "Dela med annan förälder" },
                { icon: <Sparkles size={14} />, text: "AI-genererade illustrationer" },
                { icon: <Library size={14} />, text: "Resursbibliotek" },
              ].map((f, i) => (
        ...
        <div className="lg:w-[400px] flex items-start justify-center pt-1 lg:pt-2 p-3 md:p-6">
          <div className="w-full max-w-md bg-white rounded-[24px] p-6 shadow-sm border border-black/5 text-center relative overflow-hidden">
            ...
            <p className="text-stone-500 mb-4 text-xs">
            ...
            <div className="space-y-2">
              <button onClick={handleGoogleLogin} disabled={loading} className="w-full flex items-center justify-center gap-2 bg-white border border-stone-200 py-3 px-4 rounded-xl font-medium text-stone-700 hover:bg-stone-50 hover:border-stone-300 transition-all shadow-sm active:scale-[0.98] disabled:opacity-50 text-sm">
              ...
              <button onClick={() => goTo('email-login')} disabled={loading} className="w-full flex items-center justify-center gap-2 bg-white border border-stone-200 py-3 px-4 rounded-xl font-medium text-stone-700 hover:bg-stone-50 hover:border-stone-300 transition-all shadow-sm active:scale-[0.98] disabled:opacity-50 text-sm">
                <Mail size={16} className="text-emerald-600" />
                Logga in med e-post
              </button>
              <div className="flex items-center gap-2 py-1">
                <div className="flex-1 h-px bg-stone-200" />
                <span className="text-[10px] text-stone-400 uppercase tracking-wider">eller</span>
                <div className="flex-1 h-px bg-stone-200" />
              </div>
              <button onClick={handleGuestLogin} disabled={loading} className="w-full flex items-center justify-center gap-2 bg-stone-50 border border-stone-150 py-2 px-4 rounded-xl text-xs text-stone-500 hover:bg-stone-100 hover:text-stone-700 transition-all active:scale-[0.98] disabled:opacity-50">
                <UserCircle size={14} />
                Testa som gäst
              </button>
            </div>

            <div className="mt-4 pt-3 border-t border-black/5 grid grid-cols-2 gap-3">
