...
import { Trash2, BookOpen, Image as ImageIcon, Share2, Search, Plus, CheckSquare } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          <header className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
              {(
                ...
                ] as Array<['all' | 'images' | 'text' | 'corrections', string]>
              ).map(([key, label]) => (
                <button
                  key={key}
          ...
          {filteredItems.length === 0 ? (
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-12 text-center border border-black/5 dark:border-white/5 shadow-sm">
              ...
              <p className="text-stone-500 dark:text-stone-400 max-w-xs mx-auto text-sm">{t('library.emptyDesc')}</p>
            </div>
          ) : (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-stone-400 uppercase tracking-widest font-medium">
                    {selectedItem.subject || t('library.general')}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-2">
