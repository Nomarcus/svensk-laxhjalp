    ...
    if (this.state.hasError) {
      ...
      try {
        ...
        if (parsed.error && parsed.operationType) {
          errorMessage = `Behörighetsfel vid ${parsed.operationType} på ${parsed.path}. Kontrollera dina rättigheter.`;
        }
      } catch (e) {
        // Not a JSON error
      }
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-stone-50 p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-black/5 p-8 text-center">
            <h2 className="text-2xl font-serif italic mb-4">Hoppsan!</h2>
